xml_builder.tag! "rdf:RDF",
  ...
  xml_builder.tag! "dcndl:BibResource", "rdf:about": get_record_url + "#material" do
    ...
    manifestation.publishers.each do |publisher|
      xml_builder.tag! "dcndl:publicationPlace", publisher.country.iso3166 if publisher.country
    end
    ...
    xml_builder.tag! "dcndl:extent", manifestation.extent if manifestation.extent?
    material_type = nil
